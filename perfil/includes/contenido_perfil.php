                                        ...
                                        <div class="notification__card card__scroll">
                                            ...
                                            <div class="notification__item">
                                                <div class="notification__thumb">
                                                    <a href=""><img src="assets/imagenes/meta/chatbox/01.png"
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="day-tab-3" data-bs-toggle="tab"
                                        ...
                                        aria-controls="day-tab-3-pane" aria-selected="false">
                                        Novedades <i class="fas fa-h"></i></button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-pane fade" id="day-tab-3-pane" role="tabpanel" aria-labelledby="day-tab-3"
                            ...
                            <div class="row">
                                <div class="body__card-wrapper">
                                    <div class="card__header-top">
                                        <div class="card__title-inner">
                                            <h4 class="event__information-title">Novedades</h4>
                                        </div>
