                    ...
                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="speaker__list-item mb-30">
                                                ...
                                                <div class="card__header-dropdown">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-list" style="display: none;">
                                                            <a class="dropdown__item" href="delete_publicacion.php?id=<?php echo $data->id_confecion ?>"><i class="fas fa-trash-alt"></i> Eliminar</a>
                                            ...
                                            <div class="speaker__list-content-inner">
                                                <div class="speaker__list-content">
                                                    <h5 class="speaker__author-title"><a href="../mausoleo-de-historias/la-mujer-era-un-lobo?id=<?php echo $data->id_confecion;?>"><?php echo $data->titulo ?></a></h5>
                        ...
                        <div class="tab-pane fade" id="day-tab-3-pane" role="tabpanel" aria-labelledby="day-tab-2" tabindex="0">
                            <div class="row">
                                ...
                                <form class="body__card-wrapper" action="update_usuario.php" method="POST">
                                    ...
                                    <div class="create__event-main pt-25">
                                        <div class="event__left-box">
                                            <div class="create__input-wrapper">
                                                ...
                                                <div class="contact__select mb-15">
                                                    <select name="genero">
                                                        <option <?php if ($userData->genero == 'Masculino') {
                                                                    echo 'selected';
                                                                } ?> value="Masculino">Masculino</option>
                                                        <option <?php if ($userData->genero == 'Femenino') {
                                                                    echo 'selected';
                                                ...
                                                <div class="singel__input-field mb-15">
                                                    ...
                                                    <input type="text" name="alias" placeholder="pseudonimo" value="<?php echo $userData->alias ?>">
                                                </div>
                                                <div class="event__input mb-15">
                                                    <label class="input__field-text">Descripción</label>
                                                    <textarea name="descripcion" placeholder="detalles"><?php echo $userData->descripcion ?></textarea>
                                        ...
                                        <div class="event__right-box">
                                            <div class="create__input-wrapper">
                                                ...
                                                <button class="input__btn w-100" type="cancel">
