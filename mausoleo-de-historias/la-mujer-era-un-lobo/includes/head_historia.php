...
<head>
    ...
    <meta property="og:site_name" content="Hastalatumba">
    <meta property="og:image"
        content="<?php echo $url ?><?php echo $url_historias ?><?php echo $friendly_url_historia ?><?php echo $imagenes_historia ?><?php echo $og_image ?>" />
    <meta property="og:image:secure_url"
        content="<?php echo $url ?><?php echo $url_historias ?><?php echo $friendly_url_historia ?><?php echo $imagenes_historia ?><?php echo $og_image ?>" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:image:alt" content="Hastalatumba" />
    <!--twitter description-->
    ...
    (function() {
        window.sib = {
            equeue: [],
            client_key: "p9424axw8s44dwnux0ghla9s"
        };
