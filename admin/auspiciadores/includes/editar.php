                        ...
                        <div class="col-12 col-lg-12">
                            <form action="#" class="form form--profile">
                                <div class="row row--form">
                                    <div class="col-12">
                                        <h4 class="form__title">Detalles Historia</h4>
                                    </div>

                                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                                        <div class="form__group">
                                            <label class="form__label" for="username">Título</label>
                                            <input id="titulo_historia" name="titulo_historia" class="form__input"
                                                placeholder="titulo historia">

                                            <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                                                <div class="form__group">
                                                    <label class="form__label" for="texto_historia">Contenido
                                                        Historia</label>
                                                    <input id="titulo_historia" name="titulo_historia"
                                                        class="form__input" placeholder="texto">

                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <button class="form__btn" type="button">Guardar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="main__table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--rate"><i
                                            class="icon ion-ios-star"></i> 7.9</div>
                                </td>
                                <td>
                                    <div class="main__table-text">12 / 7</div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--rate"><i
                                            class="icon ion-ios-star"></i> 8.6</div>
                                </td>
                                <td>
                                    <div class="main__table-text">67 / 22</div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--rate"><i
                                            class="icon ion-ios-star"></i> 6.0</div>
                                </td>
                                <td>
                                    <div class="main__table-text">44 / 5</div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--rate"><i
                                            class="icon ion-ios-star"></i> 5.5</div>
                                </td>
                                <td>
                                    <div class="main__table-text">8 / 132</div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--rate"><i
                                            class="icon ion-ios-star"></i> 7.0</div>
                                </td>
                                <td>
                                    <div class="main__table-text">6 / 1</div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="main__table-text main__table-text--rate"><i
                                            class="icon ion-ios-star"></i> 6.2</div>
                                </td>
                                <td>
                                    <div class="main__table-text">13 / 14</div>
                                </td>
